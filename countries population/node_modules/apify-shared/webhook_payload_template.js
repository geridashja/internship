...
exports.default = exports.InvalidVariableError = exports.InvalidJsonError = void 0;
...
class WebhookPayloadTemplate {
  ...
  _validateVariableName(variableName) {
    ...
    const [variable] = variableName.split('.'); // Properties of the variable are not validated on purpose
